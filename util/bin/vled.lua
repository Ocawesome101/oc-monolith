...
local sigHandler = function() end
-- ignore ctrl-C/ctrl-D
thread.handleSignal(thread.signals.interrupt, sigHandler)
thread.handleSignal(thread.signals.hangup, sigHandler)
